<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Tienda Del Hotel : Venta de Servicios
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Crear venta de Servicios</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option value="21">Leiva Layo Jhosep / 24562551</option>
                    <option value="20">Jesus Alvan /77889911</option>
                ...
                <button type="button" class="btn btn-default hidden-lg">Agregar Servicio</button>
        ...
        <?php
            ...
            $AgregarVentaServ= new ControladorTiendaServicio();

            $AgregarVentaServ -> ctrAgregarVentaServicio();
                      ...
                      echo '<tr>
                            ...
                            <td>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-primary btnAgregarServicio recuperarBoton"   
                                id_agregarServicio="'.$value['ID_SERVICIO'].'">   
                                      Agregar
                                </button> 
